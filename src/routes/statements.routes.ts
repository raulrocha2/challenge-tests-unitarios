...
import { CreateStatementTrasferController } from '../modules/statements/useCases/createStatementTransfer/CreateStatementTransferController';
...
const createStatementTrasferController = new CreateStatementTrasferController();
...
statementRouter.post('/transfer/:sender_id', createStatementTrasferController.execute);
