...
const createTrasferStatementController = new CreateTransferStatementController();
...
statementRouter.post('/transfer/:user_id', createTrasferStatementController.execute);
